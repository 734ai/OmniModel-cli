...
describe('omniform.tsx main function', () => {
  let consoleErrorSpy: ReturnType<typeof vi.spyOn>;
  let loadSettingsMock: ReturnType<typeof vi.mocked<typeof loadSettings>>;
  let originalEnvOmniformSandbox: string | undefined;
  ...
  beforeEach(() => {
    ...
    originalEnvOmniformSandbox = process.env.OMNIFORM_SANDBOX;
    originalEnvSandbox = process.env.SANDBOX;
    delete process.env.OMNIFORM_SANDBOX;
  ...
  afterEach(() => {
    ...
    if (originalEnvOmniformSandbox !== undefined) {
      process.env.OMNIFORM_SANDBOX = originalEnvOmniformSandbox;
    } else {
      delete process.env.OMNIFORM_SANDBOX;
    }
  ...
  it('should call process.exit(1) if settings have errors', async () => {
    ...
    const workspaceSettingsFile: SettingsFile = {
      path: '/workspace/.omniform/settings.json',
      settings: {},
    };
