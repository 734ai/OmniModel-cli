...
interface MockServerConfig {
  ...
  getModelClient: Mock<() => ModelClient | undefined>;
  getUserTier: Mock<() => Promise<string | undefined>>;
}

// Mock @omnimodel/cli-core and its Config class
vi.mock('@omnimodel/cli-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@omnimodel/cli-core')>();
...
describe('App UI', () => {
  ...
  describe('with initial prompt from --prompt-interactive', () => {
    it('should submit the initial prompt automatically', async () => {
      ...
      mockConfig.getModelClient.mockReturnValue({
