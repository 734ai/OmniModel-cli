...
const MockedModelClientClass = vi.hoisted(() =>
...
vi.mock('@omnimodel/cli-core', async (importOriginal) => {
  const actualCoreModule = (await importOriginal()) as any;
  return {
    ...actualCoreModule,
    GitService: vi.fn(),
    ModelClient: MockedModelClientClass,
...
describe('useGeminiStream', () => {
  ...
  beforeEach(() => {
    ...
    // Define the mock for getModelClient
    const mockGetModelClient = vi.fn().mockImplementation(() => {
      // MockedModelClientClass is defined in the module scope by the previous change.
      // It will use the mockStartChat and mockSendMessageStream that are managed within beforeEach.
      const clientInstance = new MockedModelClientClass(mockConfig);
    ...
    // Reset mocks for ModelClient instance methods (startChat and sendMessageStream)
    // The ModelClient constructor itself is mocked at the module level.
  ...
  const renderTestHook = (
    ...
    const client = geminiClient || mockConfig.getModelClient();
  ...
  it('should submit tool responses when all tool calls are completed and ready', async () => {
    ...
    renderHook(() =>
      useGeminiStream(
        new MockedModelClientClass(mockConfig),
        [],
        mockAddItem,
        mockSetShowHelp,
        mockConfig,
  ...
  it('should handle all tool calls being cancelled', async () => {
    ...
    const client = new MockedModelClientClass(mockConfig);
  ...
  describe('Error Handling', () => {
    it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
      ...
      const { result } = renderHook(() =>
        useGeminiStream(
          new MockedModelClientClass(testConfig),
          [],
          mockAddItem,
          mockSetShowHelp,
          testConfig,
