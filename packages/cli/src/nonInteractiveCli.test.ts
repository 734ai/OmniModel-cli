...
import { Config, ModelClient, ToolRegistry } from '@omnimodel/cli-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@omnimodel/cli-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@omnimodel/cli-core')
  >('@omnimodel/cli-core');
  return {
    ...actualCore,
    ModelClient: vi.fn(),
...
describe('runNonInteractive', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(ModelClient).mockImplementation(() => mockModelClient);
