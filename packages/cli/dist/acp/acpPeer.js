...
import { AuthType, Config, GeminiChat, ToolRegistry, logToolCall, ToolResult, convertToFunctionResponse, ToolCallConfirmationDetails, ToolConfirmationOutcome, clearCachedCredentialFile, isNodeError, getErrorMessage, isWithinRoot, getErrorStatus, } from '@google/gemini-cli-core';
...
class GeminiAgent {
    ...
    async sendUserMessage(params) {
        ...
        if (!this.chat) {
            const geminiClient = this.config.getModelClient();
