...
import { ApiErrorEvent, ApiRequestEvent, ApiResponseEvent, StartSessionEvent, ToolCallEvent, UserPromptEvent, FlashFallbackEvent, FlashDecidedToContinueEvent, LoopDetectedEvent } from './types.js';
...
export declare function logFlashDecidedToContinue(config: Config, event: FlashDecidedToContinueEvent): void;
