...
export declare class FlashDecidedToContinueEvent {
    'event.name': 'flash_decided_to_continue';
    'event.timestamp': string;
    prompt_id: string;
    constructor(prompt_id: string);
}
export type TelemetryEvent = StartSessionEvent | EndSessionEvent | UserPromptEvent | ToolCallEvent | ApiRequestEvent | ApiErrorEvent | ApiResponseEvent | FlashFallbackEvent | LoopDetectedEvent | FlashDecidedToContinueEvent;
