...
const logs = {
    getLogger: (_name) => ({
        emit: (_logRecord) => { }, // No-op for build compatibility
    }),
};
...
import { EVENT_API_ERROR, EVENT_API_REQUEST, EVENT_API_RESPONSE, EVENT_CLI_CONFIG, EVENT_TOOL_CALL, EVENT_USER_PROMPT, EVENT_FLASH_FALLBACK, EVENT_FLASH_DECIDED_TO_CONTINUE, SERVICE_NAME, } from './constants.js';
...
export function logFlashDecidedToContinue(config, event) {
