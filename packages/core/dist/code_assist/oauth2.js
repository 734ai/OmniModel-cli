...
const OAUTH_CLIENT_ID = process.env.OAUTH_CLIENT_ID || 'your-oauth-client-id.apps.googleusercontent.com';
// OAuth Secret value used to initiate OAuth2Client class.
// Note: Configure this through environment variables for security
const OAUTH_CLIENT_SECRET = process.env.OAUTH_CLIENT_SECRET || 'your-oauth-client-secret';
