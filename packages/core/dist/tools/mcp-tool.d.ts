...
export declare class DiscoveredMCPTool extends BaseTool<ToolParams, ToolResult> {
    ...
    constructor(mcpTool: CallableTool, serverName: string, serverToolName: string, description: string, parameterSchemaJson: unknown, timeout?: number, trust?: boolean, nameOverride?: string);
