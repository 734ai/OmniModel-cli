...
let mockModelClientInstance: Mocked<ModelClient>;
...
const mockConfigInternal = {
  ...
  getModelClient: vi.fn(), // Initialize as a plain mock function
  getApiKey: () => 'test-key',
  getModel: () => 'test-model',
  getSandbox: () => false,
  getDebugMode: () => false,
...
describe('WriteFileTool', () => {
  ...
  beforeEach(() => {
    ...
    // Setup ModelClient mock
    mockModelClientInstance = new (vi.mocked(ModelClient))(
      mockConfig,
    ) as Mocked<ModelClient>;
    vi.mocked(ModelClient).mockImplementation(() => mockModelClientInstance);

    // Now that mockModelClientInstance is initialized, set the mock implementation for getModelClient
    mockConfigInternal.getModelClient.mockReturnValue(
      mockModelClientInstance,
    );
